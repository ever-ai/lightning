...
class DDPStrategy(ParallelStrategy):
    ...
    def __init__(
        ...
        **kwargs: Union[Any, Dict[str, Any]],
        ...
        print(f"{self.__class__.__name__}: initializing DDP plugin")
        self._num_nodes = 1
    ...
    def setup_distributed(self):
        print(f"{self.__class__.__name__}: setting up distributed...")
        reset_seed()
    ...
    def _register_ddp_hooks(self) -> None:
        print(f"{self.__class__.__name__}: registering ddp hooks")
    ...
    def _enable_model_averaging(self) -> None:
        ...
        print(f"{self.__class__.__name__}: reinitializing optimizers with post localSGD")
    ...
    def configure_ddp(self) -> None:
        print(f"{self.__class__.__name__}: configuring DistributedDataParallel")
    ...
    def model_to_device(self):
        print(f"{self.__class__.__name__}: moving model to device [{self.root_device}]...")
    ...
    def teardown(self) -> None:
        print(f"{self.__class__.__name__}: tearing down strategy")
        super().teardown()
        ...
        if self.root_device.type == "cuda":
            # GPU teardown
            print(f"{self.__class__.__name__}: moving model to CPU")
